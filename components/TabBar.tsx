...
// SVG Icons - Opal style (thinner strokes, more elegant)
const icons = {
  home: (
...
const TabItem: React.FC<TabItemProps> = ({ icon, activeIcon, label, isActive, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {isActive && (
        <div 
          className="absolute -top-1 w-12 h-12 rounded-full opacity-40 blur-xl transition-all duration-500"
          style={{ 
      ...
      <span 
        className={`text-[11px] font-semibold mt-1 transition-all duration-300 ${
...
const TabBar: React.FC<TabBarProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50">
      ...
      {/* Tab items */}
      <div className="relative flex items-center justify-around px-2 pt-2 pb-[calc(8px+env(safe-area-inset-bottom))]">
        <TabItem
        ...
        <div className="flex-1 flex justify-center -mt-6">
          ...
          >
            {/* Static subtle glow ring - no animation */}
            <div 
